...
{
    public class Crc32Slice8Tests : BaseHashAlgorithmTests
    {
        [Fact]
        public void StaticDefaultSeedAndPolynomialWithShortAsciiString()
        {
            var actual = Crc32Slice8.Compute(SimpleBytesAscii);
        ...
        {
            var actual = Crc32Slice8.Compute(SimpleBytes2Ascii);
        ...
        {
            var hash = GetTestFileHash(Binary12KFileName, new Crc32Slice8());
        ...
        {
            var hash = GetTestFileHash(Binary1MFileName, new Crc32Slice8());
